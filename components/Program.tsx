...
const sessions: Session[] = [
    ...
    { num: 10, title: "Ветеринарный опыт в доклинических исследованиях", topics: ["Животные вне эксперимента: диагностические рутинные и уникальные процедуры", "Анатомические особенности сосудов — зачем нам это нужно знать?", "Поведенческие особенности различных видов животных", "Молоко — будничная тема для ветеринара и диковинка в доклинических исследованиях?"] },
];
