...
export default function ArchiveSection() {
    return (
        <section id="archive-section" style={{ padding: "110px 48px", background: "var(--light)" }}>
                    ...
                    {years.map((item, i) => (
                        <Reveal key={item.year} delay={120 + i * 50}>
                            <a
                                ...
                                className="archive-home-card"
                            >
                                {/* eslint-disable-next-line @next/next/no-img-element */}
                                <img src={item.img} alt={item.label} className="archive-home-card-img" />
        ...
        .archive-home-card:hover .archive-home-card-img {
        ...
        .archive-home-card-overlay {
          ...
          background: linear-gradient(
            to top,
            rgba(20, 27, 77, 0.85) 0%,
            rgba(20, 27, 77, 0.5) 50%,
            rgba(20, 27, 77, 0.35) 100%
          );
