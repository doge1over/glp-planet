...
const materials = [
    ...
    { author: "Стрелкова М.В.", title: "Научно-исследовательское оборудование для работы с животными: новинки российского рынка, перспективы развития направления", pdf: `${BASE}/strelkova_prezentacziya.pdf` },
    ...
    { author: "Сапрыкина А.А.", title: "Эндотрахеальный и интраназальный пути введения", pdf: `${BASE}/saprykina_prezentacziya.pdf` },
    ...
    { author: "Носова А.Е.", title: "Анальгезия лабораторных животных при отсутствии опиоидов. Схемы и дозировки", pdf: `${BASE}/nosova_prezentacziya.pdf` },
    ...
    { author: "Ковалева М.А.", title: "Создание системы идентификации качества лабораторных животных", pdf: `${BASE}/kovaleva_prezentacziya.pdf` },
    ...
    { author: "Гордейчук И.В.", title: "Применение приматов вида Callithrix jacchus для исследования долгосрочного созревания поствакцинального иммунного ответа", pdf: `${BASE}/gordejchuk_prezentacziya.pdf` },
    ...
    { author: "Фаустова Н.М.", title: "Применение ИФА наборов реагентов, специфичных для человека, при анализе биоматериала лабораторных животных", pdf: `${BASE}/faustova_prezentacziya.pdf` },
