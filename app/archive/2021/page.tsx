...
const materials = [
    ...
    { author: "Калинин Ю. А.", title: "Создание автоматизированной системы диспетчеризации микроклимата чистой зоны SPF вивария", pdf: "https://glp-planet.com/wp-content/uploads/2021/07/kalinin_yurij.pdf" },
    ...
    { author: "Александров А.А.", title: "Доклиническая разработка генотерапевтических препаратов", pdf: "https://glp-planet.com/wp-content/uploads/2021/07/aleksandrov-a..pdf" },
    { author: "Васютина М.Л.", title: "Laboratory animals health monitoring: from Danio Rerio to mini-pigs", pdf: "https://glp-planet.com/wp-content/uploads/2021/09/vasyutina-m_health-monitoring.pdf" },
