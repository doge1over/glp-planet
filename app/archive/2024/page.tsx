...
const materials = [
    ...
    { author: "Джинджолия В.Г." },
    { author: "Ильинский Н.С." },
    { author: "Карачевцева Д.М." },
    { author: "Майер А.И." },
    { author: "Матуа А.З." },
    { author: "Сорокина Е.Ю." },
    { author: "Суханов И.М." },
    ...
    { author: "Зиновьев С.В." },
    { author: "Иванова В.В., Мильто И.В." },
    { author: "Макарова М.Н." },
    { author: "Устенко Ж.Ю." },
    { author: "Шкорбатова П.Ю." },
    { author: "Бекетов Е.Е." },
    { author: "Гиба И.С." },
    { author: "Гремякова П.В." },
    { author: "Кильдибеков К.Ю." },
    { author: "Кищенко Н.А." },
    { author: "Платонова О.И." },
    { author: "Пелогейкина Ю.А." },
    { author: "Ситко Т.И." },
    { author: "Ходько С.В." },
    { author: "Калуев А.В." },
    { author: "Плотникова В.Д." },
    { author: "Шамаев Н.Д." },
    { author: "Осокина А.С." },
    { author: "Варнакова Л.А." },
    { author: "Власов Т.Д." },
    { author: "Галагудза М.М." },
    { author: "Гончарова А.С." },
    { author: "Милутинович К.С." },
    { author: "Панченко А.В." },
    { author: "Попов В.С." },
    { author: "Рыжков И.А." },
    { author: "Попова М.О." },
    ...
    { author: "Гуреев А.П." },
    { author: "Крылова Л.С." },
    { author: "Макаревич П.И." },
    { author: "Мальцев Д.В." },
    { author: "Сагимбаева О.С." },
    { author: "Свирщевская Е.В." },
    { author: "Андреев С.В." },
    { author: "Дейкин А.В." },
    { author: "Леонова Е.И." },
    { author: "Сенников С.В." },
    { author: "Слободкина Е.А." },
    { author: "Степанова Е.А." },
    { author: "Таубе А.А." },
    { author: "Шурыгина А.П." },
    { author: "Акимова М.А." },
    { author: "Бондарева Е.Д." },
    { author: "Добаджян Н.В." },
    { author: "Каландия Т.З." },
    { author: "Попова А.В." },
    { author: "Проскурняк Л.П." },
    { author: "Салминьш Д.А." },
    { author: "Снижко Е.А." },
    { author: "Соколова В.С." },
    ...
    { author: "Левицкая Н.Г." },
    { author: "Мазукина Е.В." },
    { author: "Шкорбатова П.Ю.", title: "Доклад (2)" },
    { author: "Абакумов М.А." },
    { author: "Бородина А.Ю." },
    { author: "Каземирчук М.С." },
    { author: "Матичин А.А." },
    { author: "Мирошников М.В." },
    { author: "Тильченко Д.А." },
    { author: "Трунов А.А." },
    { author: "Хан С.О." },
    { author: "Власенко Ю.В." },
    { author: "Зильфикаров И.Н." },
    { author: "Карлина М.В." },
    { author: "Лужанин В.Г." },
    { author: "Рождественский Д.А." },
    { author: "Солодовников А.Г." },
    { author: "Хазанов В.А." },
    { author: "Агабалаев А.А." },
    { author: "Багаева Н.С." },
    { author: "Валуев И.А." },
    { author: "Карнакова П.К." },
    { author: "Комаров Т.Н." },
    { author: "Никитина В.А." },
    { author: "Покровский М.В." },
    { author: "Савватейкина А.И." },
    { author: "Флисюк Е.В." },
    { author: "Шестакова Л.М." },
];
                ...
                <section className="conf-about">
                    <div style={{ maxWidth: 1000, margin: "0 auto" }}>
                        ...
                        <div className="conf-text">
                            <p>
                                03.07 — 05.07.2024 г. в Санкт-Петербурге прошла <strong>V Международная научная
